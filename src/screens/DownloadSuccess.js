...
const DownloadSuccess = () => {
  ...
  useEffect(() => {
    ...
    const timer = setTimeout(() => {
      navigation.navigate('BottomTabs'); // You can replace 'HomeScreen' with the screen you want to navigate to
  ...
  >
      ...
      <Text style={styles.buttonText}>Ticket downloaded successfully</Text>
